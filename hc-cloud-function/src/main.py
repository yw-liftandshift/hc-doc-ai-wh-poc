...
def main(event, context):
    ...
    documents_warehouse_properties = build_documents_warehouse_properties_from_entities(entities, blob_name, float(env_var["file_number_confidence_threshold"]), document_class)
