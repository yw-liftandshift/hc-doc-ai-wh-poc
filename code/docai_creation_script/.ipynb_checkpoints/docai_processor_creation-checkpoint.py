...
def list_processors_sample(project_id: str, location: str):
    '''
    This function gives the list of the processors in the project
    ...
    Returns:
    processor_name_list : str
                        List of the processor names 
    '''
    processor_name_list = []
...
def create_processor(display_name: str, type: str,project_id: str ,location: str) -> docai_v1beta3.Processor:
    '''
    This function creates the CDE processor
