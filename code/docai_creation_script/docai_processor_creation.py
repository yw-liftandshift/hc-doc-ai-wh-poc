...
def create_processor(display_name: str, type: str,project_id: str ,location: str) -> docai_v1beta3.Processor:
    """Creates the Processor in the specified location"""
    try:
        ...
        print(f"A Processor with the name {display_name} exist.")
...
dest_processor_number = create_processor(DEST_WORKBENCH_PROCESSOR_NAME,
